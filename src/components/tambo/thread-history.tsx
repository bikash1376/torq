    ...
    return (
      ...
      >
        <div
          ref={ref}
          className={cn(
            "border-sidebar bg-sidebar h-full transition-all duration-300 flex-none",
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={cn(
          `bg-sidebar p-1 hover:bg-sidebar-accent transition-colors rounded-md cursor-pointer absolute flex items-center justify-center`,
...
>(({ ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn(
        "flex items-center rounded-md mb-4 hover:bg-sidebar-accent transition-colors cursor-pointer relative",
  ...
  return (
    <div ref={ref} className={cn("mb-4 relative", className)} {...props}>
      ...
      <button
        ...
        className={cn(
          "p-1 hover:bg-sidebar-accent rounded-md cursor-pointer absolute left-1/2 -translate-x-1/2",
          isCollapsed
      ...
      >
        ...
        <input
          ref={searchInputRef}
          type="text"
          className="pl-10 pr-4 py-2 w-full text-sm rounded-md bg-sidebar focus:outline-none focus:ring-1 focus:ring-ring"
          placeholder="Search..."
          value={searchQuery}
      ...
      <div className="space-y-1">
        {filteredThreads.map((thread: TamboThread) => (
          <div
            ...
            className={cn(
              "p-2 rounded-md hover:bg-sidebar-accent cursor-pointer group flex items-center justify-between",
  ...
  return (
    <DropdownMenu.Root>
      <DropdownMenu.Trigger asChild>
        <button
          className="p-1 hover:bg-sidebar-accent rounded-md opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer"
          onClick={(e) => e.stopPropagation()}
        >
      ...
      <DropdownMenu.Portal>
        ...
        >
          <DropdownMenu.Item
            className="flex items-center gap-2 px-2 py-1.5 text-popover-foreground hover:bg-accent rounded-sm cursor-pointer outline-none transition-colors"
            onClick={(e) => {
              e.stopPropagation();
              onRename(thread);
            }}
